...
Barg took the time to do some write-ups about how some of the mods he and Zed have made.  If you are interested in how the game's work, or interested in making some
source-code modifications of your own, they are worth the read and well written / accessible to a beginner.
...
If you are interested in giving it a shot, the only spot with instructions right now is in the Jak Speedruns discord.
