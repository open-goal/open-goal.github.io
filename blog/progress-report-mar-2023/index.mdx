...
<ReactPlayer
  controls
  src="https://www.youtube.com/watch?v=zi8P2ufS6g0"
...
<ReactPlayer
  controls
  src={require("./vid/bombots.mp4").default}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src="https://www.youtube.com/watch?v=JwGgvItBcGA"
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={require("./vid/elevators.mp4").default}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src="https://www.youtube.com/watch?v=05gAQuCBBQs"
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src="https://www.youtube.com/watch?v=B5Tztbkx4m0"
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={require("./vid/vortex.mp4").default}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src="https://youtu.be/86JRlMxYVRI"
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={require("./vid/hellcats.mp4").default}
  className="blog-video"
/>
