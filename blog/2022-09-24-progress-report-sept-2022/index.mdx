...
It's been quite a while since we've done a progress report, but we figured as part of the Jak 2 process it would be nice to return to them.  It's nice to be able to look back on what's been accomplished as well as let people that are interested know where we are at.
...
### A lot of core engine files completed or partially started
...
### Texture Support - https://github.com/open-goal/jak-project/pull/1866
...
<!-- TODO anything to add from water? -->

### Shrubbery Decompiled - https://github.com/open-goal/jak-project/pull/1898 https://github.com/open-goal/jak-project/pull/1914
...
### Background and TFrag - https://github.com/open-goal/jak-project/pull/1909

While it lacks time of day support so far, it's great to see some parts of the actual levels already being rendered

![](./img/tfrag.png)

<!-- TODO anything to add from water? -->

### Target (aka Jak) related code - https://github.com/open-goal/jak-project/pull/1861 https://github.com/open-goal/jak-project/pull/1915

A good chunk of Jak's code has already been done and will be ready to test when the time is right

### TIE partially implemented - https://github.com/open-goal/jak-project/pull/1916
...
### Game task related code completed - https://github.com/open-goal/jak-project/pull/1884

This is the core logic behind how the game keeps track of what you have and have not completed.

With this data, a graph was created that shows in great detail how all the tasks are interconnected, and eventually we'll probably add this to the website in a more consumable form (the full graph is massive!)  In the meantime, enjoy this gigantic [SVG](./img/jak2-tasks.svg).

### Pause Menu (aka progress) is largely completed
...
### Docstring support https://github.com/open-goal/jak-project/pull/1753
...
### Speedrunner Mode - https://github.com/open-goal/jak-project/pull/1773
...
<ReactPlayer playing controls url="/videos/speedrunner-mode.webm" />
...
### Cutscene Skips - https://github.com/open-goal/jak-project/pull/1779

Most cutscens can now be skipped in Jak 1, if you don't want to accidentally skip a cutscene there is a menu option to disable this feature

<ReactPlayer playing controls url="/videos/cutscene-skips.webm" />

### Brazilian Portugeuse Translation - https://github.com/open-goal/jak-project/pull/1759
...
### Screenshot Hotkey - https://github.com/open-goal/jak-project/pull/1776
...
### Launcher releases are now automatic - https://github.com/open-goal/jak-project/pull/1788

A launcher release will now be built and released automatically after the main project releases.

### Future launcher releases should work on linux - https://github.com/open-goal/launcher/pull/36
