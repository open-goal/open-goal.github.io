...
<ReactPlayer controls src={require("./video/cratetopia.mp4").default} />
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=oNcmiJjPhdA"}
...
<ReactPlayer controls src={require("./video/zoom-blur.mp4").default} />

Adds the color filter effect, as used in Misson Failed screen:
<ReactPlayer controls src={require("./video/color-filter.mp4").default} />

`slow-time` blur effect and fixed color filter:
<ReactPlayer controls src={require("./video/slow-time.mp4").default} />
...
<ReactPlayer controls src={require("./video/sfhbg.mp4").default} />
...
<ReactPlayer controls src={require("./video/logo.mp4").default} />
