...
This month's OpenGOAL Tooling (`jak-project` repo) release is ~`0.3.4`~ `0.3.5`.
...
- Handles edge case where `iso_data` folder has been removed
...
- Improves logging on `command.spawn` errors
- Improves logging for `game_gpu_test`
- Migrates logging to tracing, instrumentation
...
### Translations <PRLink href="https://github.com/open-goal/jak-project/pull/4197"/> <PRLink href="https://github.com/open-goal/jak-project/pull/4263"/> <PRLink href="https://github.com/open-goal/jak-project/pull/4272"/> <PRLink href="https://github.com/open-goal/jak-project/pull/4281"/> <PRLink href="https://github.com/open-goal/jak-project/pull/4324"/>
...
All translations from [Crowdin](https://crowdin.com/project/opengoal) should now be updated and added to the games. This includes changes for French, Spanish, Catalan, Czech, Italian, Norwegian, Portuguese, Croatian, and Portuguese (Brazilian)! 
...
### Support Sony splash screen <PRLink href="https://github.com/open-goal/jak-project/pull/4236"/> <PRLink href="https://github.com/open-goal/jak-project/pull/4336"/>

Adds back the Sony Computer Entertainment splash screens on boot, which had been missing in OpenGOAL. Note that tooling version `0.3.5` includes a patch related to this, fixing a crash for certain languages that was happening in `0.3.4`.
...
### Include `blerc` data in GLTF exports <PRLink href="https://github.com/open-goal/jak-project/pull/4316"/>
...
<ReactPlayer
  controls
    src={require("./video/blerc.mp4").default}
/>
...
### Support controllers with identical names in imgui menu <PRLink href="https://github.com/open-goal/jak-project/pull/4290"/>

Fixes a bug where players could not select a second controller if it had an identical name as the first controller.

### Implement bulk of ARM64 instructions from x86 <PRLink href="https://github.com/open-goal/jak-project/pull/4318"/>
...
### Track orbs in crates for debug option <PRLink href="https://github.com/open-goal/jak-project/pull/4275"/> <PRLink href="https://github.com/open-goal/jak-project/pull/4312"/>
...
Copies over a change added in Jak 2 to use higher `lightning-quality` when the high LoD option is set, improving the appearance of `elec-gate`s from afar.
...
- Fixes the starting condition for speedruns - previously it required Jak to be in the `target-stance` state, so would fail if you were already moving on frame 1. This mainly affected Hero Mode runs, so it was less noticeable in Jak 2, but has also been fixed there.
- Fixes starting new game from title screen in speedrunner mode to skip intro cutscene, start autosplitter, and show verification text.
...
### Add speedrun categories for Act 2, 3, post-game <PRLink href="https://github.com/open-goal/jak-project/pull/4314"/>

Adds options to the speedrun menu for starting Act 2, Act 3, and post-game (All Open Orbs) categories.

### Implement 989snd/overlord functionality for ambient sounds <PRLink href="https://github.com/open-goal/jak-project/pull/4319"/>
...
<ReactPlayer
  controls
    src={require("./video/989snd.mp4").default}
/>

### Detect `light-trail-tracker-spawn` macro <PRLink href="https://github.com/open-goal/jak-project/pull/4317"/>
...
### Add speedrun categories for Act 2, 3, All Open Orbs <PRLink href="https://github.com/open-goal/jak-project/pull/4314"/>
