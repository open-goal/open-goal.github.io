...
This month's OpenGOAL Tooling (`jak-project` repo) release is `0.3.4`. TODO - verify this
...
- Supports texture packs for mods (TODO: not yet listed in PRs above)
- Misc internal fixes
...
TODO: not yet merged - awaiting vote from Jak 2 runners on All Open Orbs
