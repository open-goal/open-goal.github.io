...
All translations from [Crowdin](https://crowdin.com/project/opengoal) should now be updated and added to the games. This includes changes for 
...
Configures the export of the Jak 3 `goal_src` docs for the website, which you can find [here](/docs/category/jak-3).
