...
OpenGOAL now supports Jak 2's very fancy Japanese subtitles. They are actually static images instead of rendered text and not only do they have furigana, but they also have highlighted text and even display some Precurian text.
