...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=SYEALIfXZsY"}
...
<ReactPlayer controls src={require("./video/maker-projectile.webm").default} />
:::
...
<ReactPlayer controls src={require("./video/merc-fade.mp4").default} />
...
<ReactPlayer controls src={require("./video/glider-ring.mp4").default} />
<ReactPlayer controls src={require("./video/tie-texture-anim.mp4").default} />
