...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=PIrSHz4qw3Q"}
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=cpvJ3m8Otrc"}
  className="blog-video"
/>
...
<ReactPlayer controls src={require("./video/atoll_sniper.mp4").default} />
