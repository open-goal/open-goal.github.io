...
<ReactPlayer
  controls
  src={require("./video/catextmenu.mp4").default}
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=92hJcVdlrVs"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=YAKFPESqgLo"}
  className="blog-video"
/>

<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=599PUg8wq78"}
  className="blog-video"
/>

<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=5RXJO06Fazs"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=_pQvWXoDF_8"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={require("./video/seal.mp4").default}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=sP9tM1tcQP4"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=R-LGevaAQKk"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=tPM7W8N01VM"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=l41m5DQ8SXk"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=WGigcHS_koc"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=ounjWwHucek"}
  className="blog-video"
/>

<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=ipgaWitQlwk"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=Sk2mwNoQaho"}
  className="blog-video"
/>

<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=YRZorFDzwhY"}
  className="blog-video"
/>

<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=riDUtHbKRD4"}
  className="blog-video"
/>

<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=XjrowIJQa94"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=H2smmdynHVI"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=iznKhvzevAI"}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={require("./video/warpgate.mp4").default}
  className="blog-video"
/>
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=c1vxbeChJds"}
  className="blog-video"
/>
