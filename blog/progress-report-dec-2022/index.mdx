...
<ReactPlayer controls src={require("./video/music.mp4").default} />
...
<ReactPlayer controls src={require("./video/darkjak.mp4").default} />
...
<ReactPlayer controls src={require("./video/guns.mp4").default} />
...
<ReactPlayer controls src={require("./video/offline-tests.mp4").default} />
