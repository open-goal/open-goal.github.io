...
<ReactPlayer controls src={require("./video/babak-and-frong.mp4").default} />
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=kR_pGXVYL8M"}
...
<ReactPlayer controls src={require("./video/eye.mp4").default} />
...
<ReactPlayer
  controls
  src={"https://www.youtube.com/watch?v=f-SJkvBswqg"}
  className="blog-video"
/>
