...
In the original game, the Construction Side and Underport icons are green, which is actually not intended. The real colors for the icons have been restored.
