...
For Jak 2, we rectified this by naming our placeholders after the type, i.e. `type-method-[method-id]`, so we went ahead and a did a full pass through the Jak 1 codebase to either give methods proper names where possible or to apply the same naming scheme, making it a lot easier to tell at a glance what type is being used.
