...
With the generic renderer being added, the orb and skull gem in the HUD can now be drawn properly. The skull gem is requires texture animations which we have not started work on yet, which is why it looks rather static.
