...
<ReactPlayer controls src={require("./video/jak-collision.mp4").default} />

<ReactPlayer controls src={require("./video/jetboard.mp4").default} />

<ReactPlayer controls src={require("./video/jak-and-daxter.mp4").default} />
...
<ReactPlayer controls src={require("./video/mouse.mp4").default} />
...
<ReactPlayer controls src={require("./video/progress-ring.mp4").default} />
...
<ReactPlayer controls src={require("./video/ingame-sfx.mp4").default} />
...
<ReactPlayer controls src="https://www.youtube.com/watch?v=P55uBaoWXfA" />
<br />
...
<ReactPlayer controls src={require("./video/repl-binds.mp4").default} />
