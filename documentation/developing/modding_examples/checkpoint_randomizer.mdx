...
Going one layer deeper into `*game-options-pc*`, we start to see some modifiable settings, which will need to be saved to the `*pc-settings*` object and related file. 
