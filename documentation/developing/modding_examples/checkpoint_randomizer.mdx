...
```lisp
(define *num-checkpoints* 77)
(define *checkpoint-list* 
  (the-as (array string) 
    (new 'static 'boxed-array :type string :length *num-checkpoints* :allocated-length *num-checkpoints*
      "game-start"
      "village1-hut"
      "village1-warp"
      "beach-start"
...
```lisp
(let ((checkpoint-name (-> *checkpoint-list* (rand-vu-int-count *num-checkpoints*))))
...
TODO: work backwards from adjust game-info; call out modbase hook
