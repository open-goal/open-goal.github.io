...
One other section of code I'll point out is the overridden `post` handler for `progress-normal`, where the PC screens are ultimately drawn, with special positioning and scaling as needed. For example, these particular screens have quite a bit of text and need to be scaled to 65%:
