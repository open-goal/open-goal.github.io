...
EDIT: Since the time when this page was originally written, the `rand-vu` engine has been improved upon! While it still doesn't replicate the PS2's `Q` register, it does now have an adequate [source of randomness](https://github.com/open-goal/jak-project/blob/a80cff9a4c5d3383ee959c3c68c594b426745f85/goal_src/jak1/engine/math/math.gc#L202) and should no longer produce the kinds of patterns shown above.
...
Here are [all the custom checkpoints](https://github.com/dallmeyer/jak-project/compare/master...dallmeyer:jak-project:rando?w=1#diff-6491ccc7408c985642b6a5c7ba1ba31a520f909b450158ed278b1f6a6860a030) we added. We also added a way to disable any of them in the pause menu for the purists, which I'll cover [later](#randomizer-options-in-pause-menu).
