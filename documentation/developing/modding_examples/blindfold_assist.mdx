...
Today I'm going to run through the process of building a mod to assist with blindfolded runs. I chose to kick things off with this mod because it only required a few simple changes, so I think reviewing the code should be easy enough. If you want to play this mod yourself, it's waiting for you in the [Unofficial Mod Launcher](https://opengoal-unofficial-mods.github.io/) 😁
