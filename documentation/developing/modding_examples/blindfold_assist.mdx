...
# Blindfold Assist Mod - Code Review
February 16, 2023
<img style={{verticalAlign:"middle"}} src="https://github.com/dallmeyer.png" width="40px"/> <a href="https://github.com/dallmeyer"><b>barg034</b></a>

## Background

Today I'm going to run through the process of building a mod to assist with blindfolded runs. I chose to kick things off with this mod because it only required some simple changes, so I think reviewing the code should be easy enough. If you want to play this mod yourself, it's waiting for you in the [Unofficial Mod Launcher](https://opengoal-unofficial-mods.github.io/) 😁
...
When it comes to Jak, the game's responsive engine provides maybe too much flexibility in controlling Jak's movement and the camera 😅 which ends up hindering the consistency of blindfolded setups. So for this mod we'll actually be limiting some functionality - here are the two changes I set out to tackle (thanks Borrdi for the suggestions):
...
<ReactPlayer controls url={require("./video/blindfold-assist.mp4").default} className="blog-video"/>
...
- [OpenGOAL Processes and States](../../reference/process_and_state)
