...
- **OpenGOAL** , specifically the [opengoal-mod-base made by Zed and Barg](https://github.com/OpenGOAL-Unofficial-Mods/opengoal-mod-base). This has some changes made to make modding easier and most importantly has the requirements to be able to get added to the mod launcher later on.
