...
- **OpenGOAL** , specifically the [OpenGOAL mod base made by Zed and Barg](https://jakmods.dev/modbaseRedirect.html). This has some changes made to make modding easier and most importantly has the requirements to be able to get added to the mod launcher later on.
