...
Navigate to "_data\custom\_levels"_, copy the _"test-zone"_ folder, and rename it to the name of your custom level.
...
Location: _"data\goal\_src\jak1\game.gp"_
...
I'll first start by importing "village1\_background.glb" and "training\_background.glb" into my Blender file so I can locate an adequate location.
...
Location: _"data\goal\_src\jak1\engine\level\level-info.gc"_
...
Navigate to: "data\goal\_src\jak1\engine\mods\mods-settings.gc"
...
Navigate to: "data\goal\_src\jak1\engine\game\game-info.gc"
