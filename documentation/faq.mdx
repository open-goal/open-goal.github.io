...
First and foremost, for fun and the challenge. We are primarily interested in learning how the original games from the trilogy were made, and understanding the technology behind them. The end result of a working PC port that can potentially support mod and such is very motivating and exciting -- but ultimately secondary.
...
The games _Jak and Daxter: The Precursor Legacy_ and _Jak II_ are at a stage where they are feature complete and bug free on the default settings. _Jak II_ is as of writing still in beta due to a few background music issues, which shouldn't get in the way of completing the game. _Jak 3_ is in very early stages, come back later!
...
- _Jak X_ will probably _not_ be decompiled by the current developers, since their interest is mainly in the trilogy. Never forget you can still use an emulator to play these games.
...
### Will you decompile The Last Of Us? Isn't it written in GOAL?

To our konwledge, the four Jak games are the only ones ever written using GOAL. Naughty Dog did demonstrate how they use LISP in The Last Of Us.
...
All of them! For both _Jak and Daxter: The Precursor Legacy_ and _Jak II_.
...
In the future yes! We intend to make it as easy as we can to make your own code or import graphics for the game. In the meanwhile several mods can already be tried out using the unofficial mod launcher, found at 

### Will you support pressure sensitivity?

No. Pressure sensitivity is the possibility of a few controllers such as DualShock2, DualShock3 to give analog states as opposed to not binary states (pressed or not pressed) for face buttons. Even though this seems appealing for driving vehicles, there is no plan to support this, since it requires a massive game rewrite. On top of that, the vast majority of controllers doesn't support this at a hardware or driver level anyway.

We do intend to look into supporting adaptive triggers in the future, as soon as third party libraries officially support this.
<!-- https://discord.com/channels/756287461377703987/1228112614077235200 -->

### Will there be an Android Port?

Currently not planned. The game was originally written in a custom programming language called GOAL, so we had to write our own compiler, which only supports x86-64. If you are interested in compilers and extending our compiler to support ARM, ask for more details in development.
...
Curses! Contact us in the [help channel](https://discord.com/channels/756287461377703987/1019706639810580553) on the discord server and tell us about it! Post a support package as well. If you're using a Launcher, it can be generated under the help section. Make sure you tell us exactly how the crash happened and what settings you were using.
