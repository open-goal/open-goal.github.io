...
### How finished is the project? When will _Jak II_ / _Jak 3_ be out of beta?

_Jak and Daxter: The Precursor Legacy_, _Jak II_, and _Jak 3_ are at a stage where they are feature complete and fully completable. _Jak II_ and _Jak 3_ are as of writing still in beta mainly due to audio bugs and a few graphics issues, which shouldn't get in the way of completing the game.
...
- Back on the Jak 1/Jak 2/Jak 3 page, after you've completed the vanilla installation, you can go to Features > Mods to see all the mods for that game from any Mod Source(s) you've added
...
### Do you support pressure sensitivity / other controller effects?

After the [upgrade to SDL3](https://opengoal.dev/blog/progress-report-q2-2025/#controller-functionality), there is some *limited support* for pressure sensitivity and vibration effects, depending on your controller (many controllers don't support these at a hardware or driver level).
...
Note that the gun shooting effects require enabling a new "Swap R1 and R2" option.
