...
We intend to make it as easy as we can to make your own code or import graphics for the game, this is always a work-in-progress. Several mods can already be tried out using the unofficial mod launcher, found at [https://jakmods.dev/](https://jakmods.dev/).
