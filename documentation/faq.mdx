...
We support *all retail versions* of the original _Jak and Daxter_. For more details on how your version of the games matter, see [this page](./usage/game_versions.md). <span className="reddishColor">**There is no planned support for early builds and demos.**</span>
