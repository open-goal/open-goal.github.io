...
We support *all retail versions* of the original _Jak & Daxter_. For more details on how your version of the games matter, see [this page](./usage/game_versions). <span className="reddishColor">**There is no planned support for early builds and demos.**</span>
