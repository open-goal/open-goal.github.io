...
At the moment OpenGOAL only supports running the first three Jak and Daxter games. This is an open source passion project, and you're more than welcome to contribute to their development with us! See [Contributing](/docs/category/contributing) and [Developing](/docs/category/developing) for more information.
