...
function CrossReferenceLink({ text, url }) {
  if (url && url !== "#") {
    return (
      <a class="doc-symbol-link" href={url}>
        {text}
      </a>
    );
  } else {
    ...
    <details class="doc-toggle" open={closed ? !closed : true}>
      <summary class="doc-identifier-heading">
        <span class="monospaced">
          <a class="doc-identifier-link" href={`#${anchor}`} id={anchor}>
            {funcName}
          </a>
          {parse(signatureHtml)}
          {" => "}
          <CrossReferenceLink text={returnType} url={returnTypeLink} />
        </span>
        {sourceLink ? (
          <a href={sourceLink} class="doc-source-link" target="_blank">
            source
          </a>
        ) : null}
      </summary>
    ...
    <details class="doc-toggle" open={closed ? !closed : true}>
      <summary class="doc-identifier-heading">
        <span class="monospaced">
          ...
          : <CrossReferenceLink text={type} url={typeLink} />
        </span>
        {sourceLink ? (
          <a href={sourceLink} class="doc-source-link" target="_blank">
            source
...
function GenericBlock({ children, name, closed, sourceLink, typeLink, type }) {
  return (
    <details class="doc-toggle" open={closed ? !closed : true}>
      <summary class="doc-identifier-heading">
        <span class="monospaced">
          <span class="doc-identifier-link">{name}</span>:{" "}
          <CrossReferenceLink text={type} url={typeLink} />
        </span>
        {sourceLink ? (
          <a href={sourceLink} class="doc-source-link" target="_blank">
