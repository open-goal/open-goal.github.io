...
import decompFileData from "/data/progress/jak3/progress.json";
import decompHistoryData from "/data/progress/jak3/history.json";
import castData from "/data/progress/jak3/casts.json";
import {
  LineChart,
  Line,
  CartesianGrid,
...
export default function Jak3DecompProgress() {
